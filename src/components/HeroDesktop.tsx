...
import HeroShapes from './common/HeroShapes';
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <motion.div variants={slideIn} initial="hidden" animate="visible">
            ...
            >
              <AnimatedHeadline words={['BRANDING', 'THATS', 'ROLLS', 'WITH', 'YOU']} />
            </Typography>
          </motion.div>
          ...
          <motion.div variants={fadeUp} initial="hidden" animate="visible">
            ...
            >
              ...
              <strong style={{ color: '#A259FF', fontWeight: 800 }}> Boost your brand 24/7</strong>.
            </Typography>
          </motion.div>
